...
// 1) css-loader [read raw CSS file and wrap it as a ES6 module]
// 2) style-loader [take ES6 module (css) and wrap it between <style></style> tags and attach it magically to DOM]

// this loader magic is done in webpack.config.js.
 ...
 * @private
 * @param {Object} defs Default settings
